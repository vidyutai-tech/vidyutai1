...
# VidyutAI EC2 Setup Script for Ubuntu on t3.small
# Optimized for 2GB RAM instance

set -e

echo "🚀 VidyutAI EC2 Setup for Ubuntu (t3.small)"
echo "==========================================="
...
echo -e "${YELLOW}💾 Step 2: Setting up swap space (2GB) for t3.small...${NC}"
...
echo -e "${YELLOW}🔧 Step 6: Optimizing system for low memory...${NC}"
